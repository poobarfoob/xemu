                                       ...
                                       bool force)
{
    ...
    uint8_t *flipped_buf;
    bool skip_upload = pg->surface_scale_factor != 1;
    if (!skip_upload) { /* FIXME */
